...
public class RentBook {
    ...
    public void searchIdNumber() throws Exception {
        FileInputStream fis = new FileInputStream("Homework/Book1.text");
        ...
        File file1 = new File("Homework/Book1.text");
        FileWriter fw1 = new FileWriter(file1);
        File file2 = new File("Homework/Book2.text");
    ...
    private static ArrayList checkIdList() throws Exception{
        FileInputStream file = new FileInputStream("Homework/Book1.text");
        ArrayList list = new ArrayList();
    ...
    private static ArrayList checkPublisherList() throws Exception{
        FileInputStream file = new FileInputStream("Homework/Book1.text");
        ArrayList list = new ArrayList();
        Scanner c = new Scanner(file);
        String s = (String) JOptionPane.showInputDialog(
    ...
    private static ArrayList checkAuthorList() throws Exception{
        FileInputStream file = new FileInputStream("Homework/Book1.text");
        ArrayList list = new ArrayList();
        Scanner c = new Scanner(file);
        String s = (String) JOptionPane.showInputDialog(
    ...
    private static ArrayList checkTitleList() throws Exception{
        FileInputStream file = new FileInputStream("Homework/Book1.text");
        ArrayList list = new ArrayList();
        Scanner c = new Scanner(file);
        String s = (String) JOptionPane.showInputDialog(
